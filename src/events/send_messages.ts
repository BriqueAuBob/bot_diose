...
export class ReadyEvent extends Event {
  ...
  async execute() {
    ...
    //       embeds: [embed],
    //       files: [
    //         'assets/images/informations.png'
    //       ],
    ...
    //       C'est simple, il vous suffit de poster un message dans ⁠Inconnu expliquant précisément l'erreur/bug avec un screen à l'appui si possible et l'équipe de Diose s'en chargera et vous aidera.
    ...
    //         iconURL: "https://media.discordapp.net/attachments/1041410221039431731/1126866594782531724/Diose_Logo.png"
    //       });
    //       faqChannel.send({
